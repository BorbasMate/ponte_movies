...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ApiError> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex) {
        logger.error("HttpMessage not readable: ", ex);
        HttpStatus status = HttpStatus.BAD_REQUEST;

        ApiError body = new ApiError("HTTP_MESSAGE_NOT_READABLE", "The Http message is not readable ", ex.getLocalizedMessage());
    ...
    protected ResponseEntity<ApiError> handleEntityNotFoundException(EntityNotFoundException ex) {
        ...
        ApiError body = new ApiError("ENTITY_NOT_FOUND", "The given entity does not exist.", ex.getLocalizedMessage());
